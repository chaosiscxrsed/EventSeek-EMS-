            ...
            <div class="scroll-container">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <p><?php echo htmlspecialchars($row['f_des']); ?></p>
                        <p><strong>Rs. <?php echo number_format($row['f_price'], 2); ?></strong></p>
                        <label>
        ...
        <section class="section" id="entrances">
            ...
            <div class="scroll-container">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <p><?php echo htmlspecialchars($row['e_des']); ?></p>
                        <p><strong>Rs. <?php echo number_format($row['e_price'], 2); ?></strong></p>
                        <label>
